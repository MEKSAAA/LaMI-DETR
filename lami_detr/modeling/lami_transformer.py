...
from lamidetr.utils import inverse_sigmoid
...
class LaMITransformer(nn.Module):
    ...
    def __init__(
        ...
        super(LaMITransformer, self).__init__()
    ...
    def forward(
        ...
        **kwargs,
        ...
        enc_outputs_class = self.decoder.class_embed[self.decoder.num_layers](output_memory, classifier=content_class_embeds)
