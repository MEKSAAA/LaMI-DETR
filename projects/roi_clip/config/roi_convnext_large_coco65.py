...
# get default config
dataloader = get_config("common/data/coco65_base_detr.py").dataloader
...
train.output_dir = "./output/roi_clip/idow_convnext_large_coco65"
...
# model.query_path = "dataset/metadata/coco65_clip_a+cname.npy" 
# model.eval_query_path = "dataset/metadata/coco65_clip_a+cname.npy"
model.query_path = "dataset/metadata/coco_visual_desc_convnextl_65.npy" 
model.eval_query_path = "dataset/metadata/coco_visual_desc_convnextl_65.npy"
