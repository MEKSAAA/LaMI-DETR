...
# get default config
dataloader = get_config("common/data/coco_base_detr.py").dataloader
...
train.output_dir = "./output/roi_clip/idow_convnext_large_coco"
...
# model.query_path = "dataset/metadata/coco_visual_desc_convnextl.npy" 
# model.eval_query_path = "dataset/metadata/coco_visual_desc_convnextl.npy"
