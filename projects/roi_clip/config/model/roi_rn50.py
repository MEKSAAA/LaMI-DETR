...
model = L(ROI_CLIP)(
    query_path= "dataset/metadata/lvis_clip_rn50_imagenet.npy",# not for train
    eval_query_path = "dataset/metadata/lvis_clip_rn50_imagenet.npy",
    ...
    backbone=L(ModifiedResNet)(
        stem=L(CLIPStem)(in_channels=3, out_channels=64, norm="FrozenBN"),
